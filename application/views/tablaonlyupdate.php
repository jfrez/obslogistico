...
<div class="clear"></div>
  <div id="content">
<a class="btn btn-danger" href="/?/Fuentes/confirmasimple/<?php echo $tablename?>/TRUE">Confirmar Carga</a>
<h3>Se actualizarán <?php echo $table[0]['contar'];?> registros</h3>
<h3>Se insertarán <?php echo $tmp[0]['contar'];?> registros</h3>
</div>
</div>
</div>
</body>
